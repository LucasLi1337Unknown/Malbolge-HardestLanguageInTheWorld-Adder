...
(() => {
  ...
  window.runMalbolge = function(source,input,maxSteps=120000000){
    ...
    while(steps++<maxSteps){
      ...
      // Original Malbolge encrypts the cell pointed to by C *after* execution.
      if(mem[c]<33 || mem[c]>126) throw new Error(`Invalid post-cipher cell at ${c}`);
      mem[c]=x2.charCodeAt(mem[c]-33);
